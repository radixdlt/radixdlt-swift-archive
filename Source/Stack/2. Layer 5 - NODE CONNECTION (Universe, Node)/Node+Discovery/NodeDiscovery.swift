...
//    var configOfNode: (Node) -> Single<UniverseConfig> { get }
//}
//
...
//                self.networkStateOfNode(node).asObservable()
//            })
...
//    }
//
//    var networkStateOfNode: (Node) -> Single<RadixNodeState> {
////        return { node in
////            self.configOfNode(node).map {
////                RadixNodeState(node: node, universeConfig: $0)
////            }
////        }
//        fatalError("dont use, use Network Epic FindANodeEpic instead")
//    }
//
//}
//
